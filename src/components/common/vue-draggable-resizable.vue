...
export default {
  ...
  methods: {
    ...
    getParentSize() {
      if (this.parent) {
        const style = window.getComputedStyle(document.getElementById('canvas'), null);
    ...
    moveHorizontally(val) {
      ...
      const [deltaX, _] = snapToGrid(this.grid, val, this.top, 1); //eslint-disable-line
    ...
    moveVertically(val) {
      // should calculate with scale 1.
      const [_, deltaY] = snapToGrid(this.grid, this.left, val, 1); //eslint-disable-line
    ...
    changeWidth(val) {
      // should calculate with scale 1.
      const [newWidth, _] = snapToGrid(this.grid, val, 0, 1); //eslint-disable-line
    ...
    changeHeight(val) {
      // should calculate with scale 1.
      const [_, newHeight] = snapToGrid(this.grid, 0, val, 1); //eslint-disable-line
